...
//! the [core::ops::Index] traits are separately implemented for the
//! Range types.
...
/*
///Convert zstr to &str
impl<IndexType, const N: usize> core::ops::Index<IndexType> for zstr<N>
where
